...
""" The os module contains low level functions for interacting with the operating system. Higher-level modules should be used for file operations when possible. The os.open() function is not the same as the built in open() function
"""
