...
"""
Turning JSON (which is always implicitly a string) into some data type in Python is called deserialization.
Deserialization just means to convert a string into something else. Deserialization is NOT a perfect inverse of serialization.
If a serialize an object, I might not get EXACTLY the same object back when it's deserialized.
json.loads() converts the JSON into a Python data type.
"""
