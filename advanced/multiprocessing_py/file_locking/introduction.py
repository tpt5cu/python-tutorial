...
def shared_exclusive_lock():
    """
    This code uses a BSD flock-type lock on the same file descriptor. At the system level, flock ensures that duplicated (or the SAME) file
    descriptors SHARE the lock acquisition. That's why no blocking occurs.
    """
