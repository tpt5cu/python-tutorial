...
def blocking_lock():
    ...
    the second process from acquiring the lock. Only is fcntl.LOCK_NB is OR-d with fcntl.LOCK_EX or fcntl.LOCK_SH will an IOError be raised if
    blocking happens.
    """
