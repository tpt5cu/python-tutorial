...
def sequence_membership():
    ...
    Therefore, 'in' is equivalent to 'x is y or x == y'. This means that if the element is equal in memory to a sequence member or equal in value to a
    sequence member, the operator returns true.
    """
    my_list = [1, 2, 3, 4, 5]
