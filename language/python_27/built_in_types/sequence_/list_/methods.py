...
# https://www.python.org/dev/peps/pep-3132/ - unpacking implementation
...
def unpack():
    '''This work in Python 2 and 3. Tuple unpacking must be using an iterator under the hood'''
    m = map(lambda x: x + 1, [2, 3, 4])
