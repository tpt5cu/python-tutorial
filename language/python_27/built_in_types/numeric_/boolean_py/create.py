...
def str_to_bool():
    '''
    bool() evaluates the given expression and returns True or False. That means the string 'False' will return True, because 'False' is a nonempty
    sequence
    '''
    t = bool('True')
